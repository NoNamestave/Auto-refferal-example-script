...
#replace the url with your desired site

    url1 = "https://example.site/auth/signup"#place signup url page

    headers1 = {

        'Host': 'example.site',#place website here without https
        ...
        'Referer': f'https://example.site/?referral={refer}',#replace example.site with your desired site
    ...
    url2 = "https://example.site/auth/ajax_sign_up"#replace example.site with your site

    headers2 = {

        'Host': 'example.site',#place site without https
        ...
        'Origin': 'https://example.site',#you know what to do here im getting lazy right now

        'Referer': 'https://example.site/auth/signup',#yep do what you previously did on 1st header
...
num_signups = 10 #you can edit the number for your desired sign ups

refer = '1836968'  # Default referral code/chnage this if you want your refferal code to be submitted on the site
